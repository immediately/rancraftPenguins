...
public class ModelPenguinHum extends ModelBase
{
    ...
    public void setLivingAnimations(EntityLivingBase entityliving, float f, float f1, float f2)
    {
        ...
        EntityPenguinHum entitypenguin = (EntityPenguinHum)entityliving;
